...
public class LockNotificationTwo extends Service implements Runnable{
    ...
    public void onCreate() {
        ...
        new Thread(new Runnable(){
            ...
            public void run() {
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(LockNotificationTwo.this);
...
//        String location = editTextLocation.getText().toString();
        ...
        String title = "Was this you? Your vehicle was just unlocked.";
